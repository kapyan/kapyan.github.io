...
function (global, factory) {
  ...
  var TYPESET = (function () {
    ...
    return {
      ...
      zhuyin: {
        form: new RegExp('^\u02D9?(' + rZyS + ')?(' + rZyJ + ')?(' + rZyY +
          ')?(' + rZyD + ')?$'),
  ...
  var Fibre =
    ...
    function (Finder) {
      ...
      function matches(node, selector, bypassNodeType39) {
        ...
        var matches = Efn.matches || Efn.mozMatchesSelector || Efn.msMatchesSelector ||
      ...
      Fibre.fn = Fibre.prototype = {
        ...
        init: function (context, noPreset) {
          ...
          if (!context) {
            ...
            if (context instanceof Document) this.context = context.body ||
              context
      ...
      (function () {
        ...
        exposed.NON_INLINE_PROSE = function (el) {
          return hasOwn.call(exposed.NON_CONTIGUOUS_PROSE_ELEMENTS, el.nodeName
            .toLowerCase())
        }
        ...
        exposed.PRESETS = {
          prose: {
            ...
            filterElements: function (el) {
              return !hasOwn.call(exposed.NON_PROSE_ELEMENTS, el.nodeName
                .toLowerCase())
            }
          }
        }
        ...
        Finder.prototype = {
          ...
          prepareReplacementString: function (string, portion, match,
            ...
            return string.substring(portion.indexInMatch, portion.indexInMatch +
              portion.text.length)
          },
          ...
          replaceMatch: function (match, startPortion, innerPortions,
            ...
            if (matchStartNode === matchEndNode) {
              ...
              if (startPortion.indexInNode > 0) {
                ...
                preceedingTextNode = doc.createTextNode(node.data.substring(
                  0, startPortion.indexInNode))
              ...
              if (endPortion.endIndexInNode < node.length) { // ?????
                ...
                followingTextNode = doc.createTextNode(node.data.substring(
                  endPortion.endIndexInNode))
              ...
              for (var i = 0, l = innerPortions.length; i < l; ++i) {
                ...
                this.reverts.push((function (portion, innerNode) {
                  return function () {
                    innerNode.parentNode.replaceChild(portion.node,
                      innerNode)
                  }
                }(portion, innerNode)))
  ...
  Locale.support = (function () {
    ...
    function getStyle(elem, prop) {
      ...
      if (window.getComputedStyle) {
        ret = document.defaultView.getComputedStyle(elem, null).getPropertyValue(
          prop)
    ...
    return {
      ...
      'ruby-display': (function () {
        ...
        return div.querySelector('h-test-a').style.display === 'ruby' &&
      ...
      'ruby-interchar': (function () {
        ...
        div.innerHTML = '<h-test style="-moz-ruby-position:' + IC +
          ';-ms-ruby-position:' + IC + ';-webkit-ruby-position:' + IC +
          ';ruby-position:' + IC + ';"></h-test>'
